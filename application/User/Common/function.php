...
function sp_sql_users_bycatid($term_id,$tag,$where=array()){
	return ApiService::usersByTermId($term_id,$tag,$where);
}
...
function sp_sql_users_paged($tag,$pagesize=20,$pagetpl=''){
    return ApiService::usersPaged($tag,$pagesize,$pagetpl);
}
...
function sp_sql_users_paged_bycatid($term_id,$tag,$pagesize=20,$pagetpl=''){
	return ApiService::usersPagedByTermId($term_id,$tag,$pagesize,$pagetpl);
}
